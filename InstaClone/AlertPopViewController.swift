...
final class AlertPopViewController: UIViewController {
    ...
    lazy var leftButton: UIButton = {
        ...
        button.layer.borderColor = UIColor.useRGB(red: 151, green: 157, blue: 242).cgColor
        button.layer.borderWidth = 1
        button.layer.cornerRadius = 22
        button.setTitleColor(.useRGB(red: 151, green: 157, blue: 242), for: .normal)
    ...
    lazy var rightButton: UIButton = {
        let button = UIButton()
        button.backgroundColor = .useRGB(red: 151, green: 157, blue: 242)
        button.layer.cornerRadius = 22
