...
struct ReferenceValues {
    ...
    static var isClauseAgreedOrNot: Bool {
        get {
            return UserDefaults.standard.bool(forKey: "isClauseAgreedOrNot")
        }
        
        set {
            UserDefaults.standard.set(newValue, forKey: "isClauseAgreedOrNot")
        }
    }
    ...
    static var nicknameSlang: [String] {
        return (UserDefaults.standard.array(forKey: "slangNickname") as? [String]) ?? []
    }
    
    static var normalSlang: [String] {
        return (UserDefaults.standard.array(forKey: "slangNormal") as? [String]) ?? []
    }
    ...
    static var isAppAvailable: Bool = true
}
...
extension ReferenceValues {
    ...
    struct TextValue {
        struct Feed {
            static let failToLoadAddress: String = "주소를 불러올 수 없습니다."
            static let unknownAddress: String = "현재 위치를 확인 할 수 없습니다."
        }
    }
}
